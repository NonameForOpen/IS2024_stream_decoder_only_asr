...
train_config=conf/train_cllama_conformer_lora_all.yaml
cmvn=true
checkpoint=/home/storage/asr_xd02_storage/disk6/shanchanghao/models/conformer_2048D256O12N_universal_offline_a100_adamw_centor_halflr/avg_10.pt.40
expname=`basename $train_config | cut -d '.' -f 1`
dir=/home/storage/asr_xd02_storage/disk6/shanchanghao/models/tmp
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
  ...
  cmvn_opts=
  $cmvn && cp /home/storage/asr_xd02_storage/disk6/shanchanghao/models/conformer_2048D256O12N_universal_offline_a100_adamw_centor_halflr/global_cmvn $dir
